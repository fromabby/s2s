                        ...
                        <table width="640" cellpadding="0" cellspacing="0" border="0" style="margin-top:0;margin-bottom:0;margin-right:10px;margin-left:10px">
                            ...
                            <tr style="border-collapse:collapse;">
                                    <td width="640" style="font-family:HelveticaNeue,sans-serif;border-collapse:collapse">
                                        <table width="640" cellpadding="0" cellspacing="0" border="0" bgcolor="#8A0020" style="border-radius:6px 6px 0px 0px;background-color:#467AAC;color:#464646">
                                            <tbody>
                                                <tr style="border-collapse:collapse">
                            ...
                            <tr style="border-collapse:collapse">
                                <td width="640" align="center" bgcolor="#FDDA76" style="font-family:HelveticaNeue,sans-serif;border-collapse:collapse; margin-left: auto">
                                    <a href=${website} target="_blank" style="font-size:36px; color:#467AAC; text-decoration:none; font-family:'calibri', arial, verdana; display:block; margin: 20px 0px 0px 0px">
                                            <img style="max-width: 70px;" src="https://res.cloudinary.com/streets2schools/image/upload/v1650547664/websiteContentImages/sts_log_lh32tv.png" alt="logo"> 
                                        </a>
                                                                            ...
                                                                            <table border="0" cellpadding="5" cellspacing="0" width="100%" style="font-size:15px;font-family:'calibri',arial,verdana;line-height:2">
                                                                                <tbody>
                                                                                    <tr style="border-collapse:collapse">
                                                                                        ...
                                                                                        Click <a href=${link}>here</a> to reset your password. If you have not requested this email, kindly ignore this message. You may want to update your password by logging in to our website.
                                                                                        </td>
                                                                                    </tr>
                                                                                    <tr style="border-collapse:collapse">
                                                                                        <td width="100%" style="font-family:HelveticaNeue,sans-serif;border-collapse:collapse">
                                ...
                                <tr style="border-collapse:collapse">
                                    <td width="640" style="font-family:HelveticaNeue,sans-serif;border-collapse:collapse">
                                        <table width="640" cellpadding="0" cellspacing="0" border="0" bgcolor="#467AAC" style="border-radius:0px 0px 6px 6px;background-color:#467AAC;color:#e2e2e2">
                                            <tbody>
                                                <tr style="border-collapse:collapse">
                                                    <td width="30" style="font-family:HelveticaNeue,sans-serif;border-collapse:collapse"></td>
