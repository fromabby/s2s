                    ...
                    <AuthContextProvider>
                        <NavBar>
                            <PostContextProvider>
                                <CommentContextProvider>
                                    <Routes>
                                        ...
                                        />
                                        <Route path="/blog/:id" element={<PublicBlogDetails title={'Blogs'} />} />
                                        <Route
                                            path="/verify/:slug"
                                        ...
                                        <Route element={<ContributorRoutes />}>
                                            ...
                                            />
                                            <Route path="/admin/comment" element={<CommentList title={'Manage Comments'} />} />
                                        </Route>
                                    </Routes>
                                </CommentContextProvider>
                            </PostContextProvider>
                                ...
                                <Routes>
                                    <Route element={<ContributorRoutes />}>
                                        ...
                                        <Route
                                            ...
                                            element={<CreateAboutForm title={`Add New Awards and Recognition`} />}
                                        />
                                        <Route
                                            path="/admin/about/:id"
                                            element={<UpdateAboutForm title={`Update Awards and Recognitions`} />}
                                        />
                                    </Route>
                                </Routes>
                            </AboutContextProvider>
                            ...
                            <DonationContextProvider>
                                <Routes>
                                    <Route element={<ContributorRoutes />}>
                                        <Route
                                            path="/admin/donation"
                                            element={<DonationList title={`Manage Donation Links`} />}
                                        />
                                        <Route
                                ...
                                <Routes>
                                    <Route element={<ContributorRoutes />}>
                                        <Route
                                            ...
                                            element={
                                                <RegistrationList title={`Manage Registration Links`} />
                                            }
                                        />
                                        <Route
                                            path="/admin/registration/new"
                                            element={ <CreateRegistrationForm title={`Add New Registration Link`} /> }
                                        />
                                        <Route
                                            path="/admin/registration/:id"
                                            element={ <UpdateRegistrationForm title={`Update Registration Link`} /> }
                                        />
                                    </Route>
                                </Routes>
                            </RegistrationContextProvider>
                            ...
                            <Routes>
                                ...
                                <Route
                                    path="/faqs"
                                    element={ <FrequentlyAskedQuestions title={`Frequently Asked Questions`} />
                                    }
                                />
