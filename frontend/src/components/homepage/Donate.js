...
const DonateModal = ({ donationDetails }) => {
    ...
    return (
        <div className="donation-modal">
            <h1 style={{ fontSize: "4.5em" }} className="text-center"> Donation Platforms </h1>
            <div className="image-container-donate">
                ...
                {
                    (donationDetails[0]?.bank_name.toLowerCase() !== 'gcash' && donationDetails[1]?.bank_name.toLowerCase() !== 'bpi') && <h3>No links available</h3>
                }
            </div>
